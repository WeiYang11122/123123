...
dataset =load('./data/01_Data_Screen/Feat_scale_1_energy.mat');
addition_Feat_scale_1_energy = dataset.Feat_scale_1_energy;
dataset =load('./data/01_Data_Screen/Feat_scale_2_energy.mat');
addition_Feat_scale_2_energy = dataset.Feat_scale_2_energy;
dataset =load('./data/01_Data_Screen/Feat_scale_3_energy.mat');
addition_Feat_scale_3_energy = dataset.Feat_scale_3_energy;
dataset =load('./data/01_Data_Screen/Feat_scale_4_energy.mat');
addition_Feat_scale_4_energy = dataset.Feat_scale_4_energy;
dataset =load('./data/01_Data_Screen/Feat_scale_5_energy.mat');
addition_Feat_scale_5_energy = dataset.Feat_scale_5_energy;
...
data = [SLFs_datasets addition_Feat_scale_1_energy addition_Feat_scale_2_energy addition_Feat_scale_3_energy addition_Feat_scale_4_energy addition_Feat_scale_5_energy];
...
[crossvalind_num other] = size(data);
indices = crossvalind('Kfold',crossvalind_num,foldNum);
save('./data/01_Data_Screen/guiding.mat','indices');% save for 5-fold cross-validation


addition_Feat_scale_1_energy(ind_data,:) = [];addition_Feat_scale_1_energy(ind,:) = [];
addition_Feat_scale_2_energy(ind_data,:) = [];addition_Feat_scale_2_energy(ind,:) = [];
addition_Feat_scale_3_energy(ind_data,:) = [];addition_Feat_scale_3_energy(ind,:) = [];
addition_Feat_scale_4_energy(ind_data,:) = [];addition_Feat_scale_4_energy(ind,:) = [];
addition_Feat_scale_5_energy(ind_data,:) = [];addition_Feat_scale_5_energy(ind,:) = [];
...
for db_num = 1:length(data_db_num)
    ...
    cmethod_list = {'Feat_scale_1_energy','Feat_scale_2_energy','Feat_scale_3_energy','Feat_scale_4_energy','Feat_scale_5_energy'};
    for CC_chain_num = 1:length(cchain_method_list)
        ...
        for CC_method_num = 1:length(cmethod_list)
            ...
            if strcmp(cmethod,'Feat_scale_1_energy')
                handld_data = [SLFs_datasets(:,2:841) addition_Feat_scale_1_energy];
            end
            if strcmp(cmethod,'Feat_scale_2_energy')
                handld_data = [SLFs_datasets(:,2:841) addition_Feat_scale_2_energy];
                        end
           if strcmp(cmethod,'Feat_scale_3_energy')
                handld_data = [SLFs_datasets(:,2:841) addition_Feat_scale_3_energy];
           end
            if strcmp(cmethod,'Feat_scale_4_energy')
                handld_data = [SLFs_datasets(:,2:841) addition_Feat_scale_4_energy];
                        end
           if strcmp(cmethod,'Feat_scale_5_energy')
                handld_data = [SLFs_datasets(:,2:841) addition_Feat_scale_5_energy];
           end
            ...
            signal_subset_accuracy_save = [];signal_subset_accuracy_save{foldNum} = [];
            multi_subset_accuracy_save = [];multi_subset_accuracy_save{foldNum} = [];
