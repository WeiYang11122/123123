...
dataset =load('./data/01_Data_Screen/Feat_scale_1_orientation.mat');
addition_Feat_scale_1_orientation = dataset.Feat_scale_1_orientation;
dataset =load('./data/01_Data_Screen/Feat_scale_2_orientation.mat');
addition_Feat_scale_2_orientation = dataset.Feat_scale_2_orientation;
dataset =load('./data/01_Data_Screen/Feat_scale_3_orientation.mat');
addition_Feat_scale_3_orientation = dataset.Feat_scale_3_orientation;
dataset =load('./data/01_Data_Screen/Feat_scale_4_orientation.mat');
addition_Feat_scale_4_orientation = dataset.Feat_scale_4_orientation;
dataset =load('./data/01_Data_Screen/Feat_scale_5_orientation.mat');
addition_Feat_scale_5_orientation = dataset.Feat_scale_5_orientation;
...
data = [SLFs_datasets addition_Feat_scale_1_orientation addition_Feat_scale_2_orientation addition_Feat_scale_3_orientation 
    addition_Feat_scale_4_orientation addition_Feat_scale_5_orientation];
...
addition_Feat_scale_1_orientation(ind_data,:) = [];addition_Feat_scale_1_orientation(ind,:) = [];
addition_Feat_scale_2_orientation(ind_data,:) = [];addition_Feat_scale_2_orientation(ind,:) = [];
addition_Feat_scale_3_orientation(ind_data,:) = [];addition_Feat_scale_3_orientation(ind,:) = [];
addition_Feat_scale_4_orientation(ind_data,:) = [];addition_Feat_scale_4_orientation(ind,:) = [];
addition_Feat_scale_5_orientation(ind_data,:) = [];addition_Feat_scale_5_orientation(ind,:) = [];
...
for db_num = 1:length(data_db_num)
    ...
    for CC_chain_num = 1:length(cchain_method_list)
        ...
        for CC_method_num = 1:length(cmethod_list)
            ...
            if strcmp(cmethod,'SLFs_orientation_scale_1')
                handld_data = [SLFs_datasets(:,2:841) addition_Feat_scale_1_orientation];
            end
            if strcmp(cmethod,'SLFs_orientation_scale_2')
                handld_data = [SLFs_datasets(:,2:841) addition_Feat_scale_2_orientation];
                        end
           if strcmp(cmethod,'SLFs_orientation_scale_3')
                handld_data = [SLFs_datasets(:,2:841) addition_Feat_scale_3_orientation];
           end
            if strcmp(cmethod,'SLFs_orientation_scale_4')
                handld_data = [SLFs_datasets(:,2:841) addition_Feat_scale_4_orientation];
                        end
           if strcmp(cmethod,'SLFs_orientation_scale_5')
                handld_data = [SLFs_datasets(:,2:841) addition_Feat_scale_5_orientation];
           end
